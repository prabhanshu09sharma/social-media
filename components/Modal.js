...
const Modal = () => {
    ...
    return (
        <div className='fixed top-0 left-0 z-[20] h-screen w-screen bg-[#242d34bb]' onClick={closeModal}>

            <div className='bg-black w-[350px] md:w-[650px] text-white absolute left-[50%]
                    translate-x-[-50%] mt-[40px] p-4 rounded-[20px]'
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='flex justify-between items-center'>
                            <div className='flex gap-4 text-[20px] text-[#1d9bf0]'>
                                ...
                                <div className='border-[#1d9bf0] border rounded h-[18px] 
                                    text-[16px] grid place-items-center'>
                                    <AiOutlineGif />
                                </div>
